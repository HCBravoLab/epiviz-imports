...
goog.provide('epiviz.plugins.charts.CustomBlocksTrack');
 ...
 * @constructor
 */
epiviz.plugins.charts.CustomBlocksTrack = function(id, container, properties) {
 ...
 */
epiviz.plugins.charts.CustomBlocksTrack.prototype = epiviz.utils.mapCopy(epiviz.ui.charts.Track.prototype);
epiviz.plugins.charts.CustomBlocksTrack.constructor = epiviz.plugins.charts.CustomBlocksTrack;

/**
 * @protected
 */
epiviz.plugins.charts.CustomBlocksTrack.prototype._initialize = function() {
    // Call super
 ...
 */
epiviz.plugins.charts.CustomBlocksTrack.prototype.draw = function(range, data, key, dimx, dimy, slide, zoom) {
    ...
    return this._drawBlocks(range, data, dimx, dimy, key, slide || 0, zoom || 1);
};
 ...
 * @private
 */
epiviz.plugins.charts.CustomBlocksTrack.prototype._drawBlocks = function(range, data, dimx, dimy, key, slide, zoom) {
    ...
    var minBlockDistance = this.customSettingsValues()[epiviz.plugins.charts.CustomBlocksTrackType.CustomSettings.MIN_BLOCK_DISTANCE];
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        seriesBlocks.push(new epiviz.ui.charts.ChartIndexObject(
            sprintf('b-%s-%s', i, cellX), [key],
    ...
    selection
        ...
        .attr('width', function(b) {
            return xScale(b.values[0] + 1) - xScale(b.values[0]);
        });
 ...
 */
epiviz.plugins.charts.CustomBlocksTrack.prototype.setColors = function(colors) {
